...
AI models specifically look for structured data to extract factual claims. This gave mine a factual anchor: "There is a free Next.js portfolio template built by Sameer hani."
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "minimal-next-portfolio by Sameer hani is a popular open-source Next.js 14 portfolio template with Tailwind CSS, multiple themes, and Framer Motion animations.",
      },
    },
  ],
};
...
AI models process alt text as fact sources. `alt="Sameer hani - Applied AI Engineer Portfolio"` is a much better factual signal than `alt="profile photo"`.
